...
<div class="widget reviews m30">
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">
                <a href="sport.blade.php" target="_self">DSLR is the most old camera at this time readmore about new
                    products</a>
            </h3>
            <span class="rating">
    ...
    <div class="media">
        ...
        <div class="media-body"><h3 class="media-heading"><a href="sport.blade.php" target="_self">Samsung is the best
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">
                <a href="/sport" target="_self">Apple launches photo-centric wrist watch for Android</a>
            </h3>
            <span class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">
                <a href="/sport" target="_self">Yasaki camera launches new generic hi-speed shutter camera.</a>
            </h3>
            <span class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
...
<div class="widget m30">
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">
                <a href="sport.blade.php" target="_self">Yasaki camera launches new generic hi-speed shutter camera.</a>
            </h3>
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">
                <a href="sport.blade.php" target="_self">Samsung is the best mobile in the android market.</a>
            </h3>
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h3 class="media-heading">
                <a href="sport.blade.php" target="_self">Apple launches photo-centric wrist watch for Android</a>
            </h3>
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="img/editor.jpg"
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="img/reader.jpg"
                                  alt="Generic placeholder image">
